...
void packet_d2gs_d2gs_npccancel(struct connection *conn, struct packet *request) {
  ...
  packet.npc_id = packet_get_int(request, ENDIAN_LITTLE);
  ...
  EINA_LOG_CRIT("packet_d2gs_d2gs_npccancel not yet implemented."); packet_free(response); return;
